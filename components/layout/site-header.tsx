    ...
    <header className="relative z-20 h-[74px] border-b border-border bg-bg/40">
      <Container className="grid h-full grid-cols-[160px_1fr_auto] items-center gap-6">
        ...
        <div className="flex items-center justify-end gap-4">
          ...
          <span className="flex h-9 items-center gap-2.5 rounded-full border border-[#2b5535] bg-[#102317] py-1 pl-1.5 pr-3.5 text-[13px] font-medium text-[#82b777]">
            <span className="size-6 shrink-0 overflow-hidden rounded-full ring-1 ring-[#426f48]/45">
              <Image
