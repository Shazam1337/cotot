...
export const demoSignals: DemoSignal[] = [
  {
    ...
    engagementRate: 4.5,
    post: [
      "ONIX links public activity to measurable contribution.",
      "Each event receives a clear status and attribution record.",
      "Distribution is modeled on Solana.",
    ],
    mediaKicker: "Creator revenue protocol",
    mediaTitle: "ACTIVITY, ATTRIBUTED.",
  },
  {
    id: "04282",
    creatorId: "lunarvibe",
    ...
    engagements: 296,
    engagementRate: 4.4,
    post: ["The event is now tracked.", "Its contribution is measured in the current cycle."],
  ...
  },
  {
    ...
    engagements: 467,
    engagementRate: 4,
    post: ["Public activity can be measured and linked to a distribution record."],
  ...
  },
  {
    ...
    engagements: 408,
    engagementRate: 3.8,
    post: ["A clear attribution record makes contribution inspectable."],
  ...
  },
  {
    ...
    engagements: 214,
    engagementRate: 4.1,
    post: ["ONIX organizes public activity into a traceable event stream."],
    mediaKicker: "Signal detected",
    mediaTitle: "TRACK THE EVENT.",
  },
  {
    id: "04269",
    creatorId: "alex",
